...
#define IPU_MEM_CONST_SYSM3	0x80000000
#define IPU_MEM_IPC_HEAP0	0xA0000000
 ...
 *
 * A 0 physcial address (second parameter) means this physical region should
 * be dynamically carved out at boot time.
 */
static struct rproc_mem_entry ipu_memory_maps[] = {
	{IPU_MEM_IPC_HEAP0, 0, SZ_1M}, /* keep this IPC region first */
	{0, 0, SZ_16M},
	{IPU_MEM_CONST_SYSM3, 0, SZ_16M},
...
static int __init omap_rproc_init(void)
{
	...
	/* dynamically allocate boot memory as required by the ipu */
