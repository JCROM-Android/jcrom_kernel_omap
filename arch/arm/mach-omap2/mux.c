...
MUX_CFG_34XX("K8_34XX_GPMC_WAIT2", 0x0D0,
		OMAP34XX_MUX_MODE4 | OMAP34XX_PIN_OUTPUT)
/* BT/FM nShutDown GPIOs
 */
MUX_CFG_34XX("BT_3430_GPIO161", 0x196,	/* FM Enable GPIO */
		OMAP34XX_MUX_MODE4 | OMAP2_PULL_UP | OMAP2_PULL_ENA)
MUX_CFG_34XX("BT_3430_GPIO159", 0x192,	/* FM Enable - DBG GPIO */
		OMAP34XX_MUX_MODE4 | OMAP2_PULL_UP | OMAP2_PULL_ENA)
MUX_CFG_34XX("BT_3430_GPIO109", 0x12A,	/* BT Enable NShutDown GPIO */
		OMAP34XX_MUX_MODE4 | OMAP2_PULL_UP | OMAP2_PULL_ENA)
};
