...
#ifndef CONFIG_SMC_KERNEL_CRYPTO_STANDALONE
/*
...
#endif /* SMC_KERNEL_CRYPTO_STANDALONE */
...
#ifdef CONFIG_SMC_KERNEL_CRYPTO_STANDALONE
static int __init register_dmcrypt_engines(void)
{
        int ret;

        printk(KERN_ERR "************************Entered register_dmcrypt_engines*********************************");
...
#else /* ! CONFIG_SMC_KERNEL_CRYPTO_STANDALONE */
module_init(SCXLNXDeviceRegister);
#endif /* CONFIG_SMC_KERNEL_CRYPTO_STANDALONE */
