...
static long SCXLNXCtrlDeviceIoctl(struct file *file, unsigned int cmd, unsigned long param)
{
...
exit:
        mutex_unlock(&pDevice->dev_mutex);
	return nResult;
}
...
static const struct file_operations g_SCXLNXCtrlDeviceFileOps = {
	...
	.unlocked_ioctl = SCXLNXCtrlDeviceIoctl,
	.llseek = no_llseek,
};
